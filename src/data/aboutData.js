export const aboutData = {
  ...
  description2:
    'I grew up in Coventry, had cross country national trials in high school, graduated with a BSc in Biochem & Neuroscience. I then wanted to fulfill a dream to live in Japan and broaden my skills and left for greener pastures to Osaka, Japan in 2015, where I immersed in the culture & language for two years and developed an addiction to (authentic) sushi. I returned to the UK and joined a Japanese international manufacturing company involved in Semiconductors where I travelled all over the EU regularly. Here I picked up essential German phrases like "Ein Weissbier, bitte" ',
  description3:
    'After my experience of early 2000s-esque Japanese bureaucratic online systems, this spurred me on to change career and to have a more flexible work-life balance and in late 2019 I enrolled in MSc Computer Sci at UoB. At the time I had no experience with programming but I had a clear vision of an app I wanted to create. After failing many times on my journey I managed to create the application I envisaged (see honyomi below). I would like to enable and share my knowledge to those who are creative or are thinking about a career in software',
  image: 2,
};
